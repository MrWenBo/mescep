...
/**
 * KPreparetaskSum10daysId generated by hbm2java
 */
public class KPreparetaskSum10daysId implements java.io.Serializable {
	...
	public KPreparetaskSum10daysId() {
	}

	public KPreparetaskSum10daysId(String deptid, Date day, String prepareTaskType, BigDecimal sendPrepareCount,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof KPreparetaskSum10daysId))
			return false;
		KPreparetaskSum10daysId castOther = (KPreparetaskSum10daysId) other;
