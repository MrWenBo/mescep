...
/**
 * BvRoutineId generated by hbm2java
 */
public class BvRoutineId implements java.io.Serializable {
	...
	public BvRoutineId(BigDecimal uniqueid, String routing, BigDecimal operationId, BigDecimal opuid) {
	...
	public BvRoutineId(String operationName, String operationGroup, BigDecimal preopTime, BigDecimal unitRuntime,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BvRoutineId))
			return false;
		BvRoutineId castOther = (BvRoutineId) other;
		...
		return ((this.getOperationName() == castOther.getOperationName())
				...
				&& ((this.getOptypedesc() == castOther.getOptypedesc())
						|| (this.getOptypedesc() != null && castOther.getOptypedesc() != null
								&& this.getOptypedesc().equals(castOther.getOptypedesc())));
	}
