...
/**
 * TvDispatchorderId generated by hbm2java
 */
public class TvDispatchorderId implements java.io.Serializable {
	...
	public TvDispatchorderId() {
	}

	public TvDispatchorderId(BigDecimal uniqueid, String taskuid) {
		this.uniqueid = uniqueid;
		this.taskuid = taskuid;
	}

	public TvDispatchorderId(BigDecimal uniqueid, String resuid, String taskuid, String employeeid,
			BigDecimal assnunits, Long assntype, String creator, Date createtime, Byte isineffect, Date assnstart,
			Date assnfinish, BigDecimal assnqty, BigDecimal assnwork, Long assnstate, String notes,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TvDispatchorderId))
			return false;
		TvDispatchorderId castOther = (TvDispatchorderId) other;
		...
		return ((this.getUniqueid() == castOther.getUniqueid()) || (this.getUniqueid() != null
				...
				&& ((this.getActualwork() == castOther.getActualwork())
						|| (this.getActualwork() != null && castOther.getActualwork() != null
								&& this.getActualwork().equals(castOther.getActualwork())));
	}
