...
/**
 * IWarehousemanagerId generated by hbm2java
 */
public class IWarehousemanagerId implements java.io.Serializable {

	private String warehouseid;
	private String employeeid;

	public IWarehousemanagerId() {
	}

	public IWarehousemanagerId(String warehouseid, String employeeid) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IWarehousemanagerId))
			return false;
		IWarehousemanagerId castOther = (IWarehousemanagerId) other;
