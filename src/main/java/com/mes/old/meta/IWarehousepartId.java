...
/**
 * IWarehousepartId generated by hbm2java
 */
public class IWarehousepartId implements java.io.Serializable {

	private String warehouseid;
	private String partNumber;

	public IWarehousepartId() {
	}

	public IWarehousepartId(String warehouseid, String partNumber) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IWarehousepartId))
			return false;
		IWarehousepartId castOther = (IWarehousepartId) other;
