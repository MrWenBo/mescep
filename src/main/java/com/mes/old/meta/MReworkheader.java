...
/**
 * MReworkheader generated by hbm2java
 */
public class MReworkheader implements java.io.Serializable {
	...
	private Set MReworkdetails = new HashSet(0);

	public MReworkheader() {
	}

	public MReworkheader(String reworkuid, String reworkid) {
		this.reworkuid = reworkuid;
		this.reworkid = reworkid;
	}

	public MReworkheader(String reworkuid, MDefectjudgeheader MDefectjudgeheader, String reworkid, String taskuid,
			...
			BigDecimal qtyneedtorework, String accountant, Set MReworkdetails) {
		this.reworkuid = reworkuid;
		...
		this.MReworkdetails = MReworkdetails;
	}
	...
	public Set getMReworkdetails() {
		return this.MReworkdetails;
	}

	public void setMReworkdetails(Set MReworkdetails) {
		this.MReworkdetails = MReworkdetails;
	}
