...
/**
 * TvConsumedMaterialId generated by hbm2java
 */
public class TvConsumedMaterialId implements java.io.Serializable {
	...
	private String bcreator;
	private Date bcreatime;
	...
	public TvConsumedMaterialId() {
	}

	public TvConsumedMaterialId(String taskuid, String partNumber, String deptid, String producedPartNumber,
			String consumedPartNumber, long uniqueid) {
	...
	public TvConsumedMaterialId(String taskuid, String taskid, String taskname, String model, String batchnum,
			String partNumber, BigDecimal dueqty, Date earlystart, Date earlyfinish, Date latestart, Date latefinish,
			...
			Integer resourcestate, String parentuid, String creator, Date createtime, String notes, Byte needcheck,
			String rootbatchnum, BigDecimal completework, String text1, Long startendmark, String text2, String text3,
			String text4, String text5, String text6, String text7, String text8, String text9, String text10,
			String checker, Date checkdate, BigDecimal check1qty, BigDecimal check2qty, BigDecimal check3qty,
			BigDecimal check4qty, BigDecimal check5qty, BigDecimal check6qty, BigDecimal check7qty,
			BigDecimal check8qty, BigDecimal check9qty, String checknotes, String warehouseid, Byte isCriticalOperation,
			Byte agreestate, String taskstatedesc, String tasktypedesc, String agreestatedesc, String partName,
			String deptiddesc, String mastershopdesc, String modeldesc, String uomdesc, String producedPartNumber,
			String consumedPartNumber, BigDecimal minFixedShrinkage, BigDecimal minPercentShrinkage, Byte phantom,
			Date ecnDate, String ecnDescription, Date ecnDateFormat, BigDecimal producedQuantity,
			BigDecimal consumedQuantity, String ecnCode, Long ecnLevel, Long ecnNumber, Byte usableByNewMfgOrder,
			BigDecimal normPercentShrinkage, BigDecimal normFixedShrinkage, BigDecimal minQuantity,
			String producedQuantityUom, String process, String quantityConstraintType, String consumedQuantityUom,
			Byte flexibleMinQuantityP, BigDecimal maxQuantity, BigDecimal multipleQuantity, String attributeConsumed,
			String attributeProduced, String changer, Date changetime, Byte changestate, String bcreator,
			Date bcreatime, long uniqueid, Byte effective, String consumedpartnumberdesc, String consumedpartnumberuom,
			String producedpartnumberdesc, String producedpartnumberuom, String operationName, BigDecimal invqty,
			String warehouse) {
		this.taskuid = taskuid;
		this.taskid = taskid;
	...
	public Date getBcreatime() {
		return this.bcreatime;
	}

	public void setBcreatime(Date bcreatime) {
		this.bcreatime = bcreatime;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TvConsumedMaterialId))
			return false;
		TvConsumedMaterialId castOther = (TvConsumedMaterialId) other;
		...
		return ((this.getTaskuid() == castOther.getTaskuid()) || (this.getTaskuid() != null
				...
				&& ((this.getProducedPartNumber() == castOther.getProducedPartNumber())
				...
				&& ((this.getBcreator() == castOther.getBcreator()) || (this.getBcreator() != null
						&& castOther.getBcreator() != null && this.getBcreator().equals(castOther.getBcreator())))
				&& ((this.getBcreatime() == castOther.getBcreatime()) || (this.getBcreatime() != null
						&& castOther.getBcreatime() != null && this.getBcreatime().equals(castOther.getBcreatime())))
				...
				&& ((this.getWarehouse() == castOther.getWarehouse()) || (this.getWarehouse() != null
						&& castOther.getWarehouse() != null && this.getWarehouse().equals(castOther.getWarehouse())));
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (getBcreator() == null ? 0 : this.getBcreator().hashCode());
		result = 37 * result + (getBcreatime() == null ? 0 : this.getBcreatime().hashCode());
		...
		result = 37 * result + (getWarehouse() == null ? 0 : this.getWarehouse().hashCode());
		return result;
	}
