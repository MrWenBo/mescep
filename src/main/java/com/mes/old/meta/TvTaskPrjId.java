...
/**
 * TvTaskPrjId generated by hbm2java
 */
public class TvTaskPrjId implements java.io.Serializable {
	...
	private BigDecimal parttaskstate;
	private Date partearlystart;
	...
	public TvTaskPrjId(String taskuid, String partNumber, String deptid, String parttaskuid) {
	...
	public TvTaskPrjId(String taskuid, String taskname, Long startendmark, BigDecimal taskstate, String model,
			...
			Byte agreestate, Byte locked, String text1, BigDecimal parttaskstate, Date partearlystart,
			Date partlatefinish, String parttaskuid, String partName, String drawingid, Long plangrade) {
		this.taskuid = taskuid;
		...
		this.locked = locked;
		this.text1 = text1;
		this.parttaskstate = parttaskstate;
		this.partearlystart = partearlystart;
	...
	public BigDecimal getParttaskstate() {
		return this.parttaskstate;
	}

	public void setParttaskstate(BigDecimal parttaskstate) {
		this.parttaskstate = parttaskstate;
	}

	public Date getPartearlystart() {
		return this.partearlystart;
	}

	public void setPartearlystart(Date partearlystart) {
		this.partearlystart = partearlystart;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TvTaskPrjId))
			return false;
		TvTaskPrjId castOther = (TvTaskPrjId) other;
		...
		return ((this.getTaskuid() == castOther.getTaskuid()) || (this.getTaskuid() != null
				...
				&& ((this.getParttaskstate() == castOther.getParttaskstate())
						|| (this.getParttaskstate() != null && castOther.getParttaskstate() != null
								&& this.getParttaskstate().equals(castOther.getParttaskstate())))
				&& ((this.getPartearlystart() == castOther.getPartearlystart())
						|| (this.getPartearlystart() != null && castOther.getPartearlystart() != null
								&& this.getPartearlystart().equals(castOther.getPartearlystart())))
				...
				&& ((this.getParttaskuid() == castOther.getParttaskuid())
						|| (this.getParttaskuid() != null && castOther.getParttaskuid() != null
								&& this.getParttaskuid().equals(castOther.getParttaskuid())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getParttaskstate() == null ? 0 : this.getParttaskstate().hashCode());
		result = 37 * result + (getPartearlystart() == null ? 0 : this.getPartearlystart().hashCode());
		result = 37 * result + (getPartlatefinish() == null ? 0 : this.getPartlatefinish().hashCode());
		result = 37 * result + (getParttaskuid() == null ? 0 : this.getParttaskuid().hashCode());
